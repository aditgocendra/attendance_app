...
public class ModelAttendanceUsers {
    ...
    public ModelAttendanceUsers() {
    }

    public ModelAttendanceUsers(double latitudeIn, double longitudeIn, double latitudeOut, double longitudeOut, String distanceIn, String distanceOut, String day, String timeIn, String timeOut, String keyUser) {
